...
class TableDefinition {
	...
	{
		return "GEN_ID_"+fd.columnName;
	}
	
	private static String nameSymbol(FieldDefinition fd)
	{
		return "GEN_FIELD_"+fd.columnName;
	}
	...
	void generateClassDefinition( PrintWriter pw)
	{
		...
		pw.println( "// Do not edit this file directly");
		...
		for ( FieldDefinition fd : fieldDefinitions)
		{
			...
			id.iprintln(MessageFormat.format("values.put(GEN_FIELD_{0},{1});", fd.columnName, stringValue));
		}
